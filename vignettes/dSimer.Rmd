...
csl: nature.csl
vignette: |
  %\VignetteIndexEntry{Integration of disease similarity methods and disease network visualization} %\VignettePackage{dSimer} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8}
---
